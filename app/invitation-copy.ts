...
export const COPY = {
  en: {
    ...
    eventTimes: {
      ...
      ring: "09:30 AM",
      haldi: "11:00 AM · Lunch at 12:30 PM",
      mameru: "03:00 PM",
      sangeet: "07:30 PM",
      wedding: "",
    },
    venues: {
      tremont: "B.1302, Tremont, Vaishnodevi Circle, Ahmedabad",
      narayani: "Narayani Heights, Airport-Gandhinagar Road, Bhat, Ahmedabad",
    },
  ...
  gu: {
    ...
    heights: "હાઇટ્સ",
    venueDescription:
      "હરિયાળાં લૉન, ભવ્ય સમારંભ સ્થળો અને યાદગાર ઉજવણી માટેનું સુંદર વાતાવરણ.",
    ...
    eventTimes: {
      ...
      ring: "સવારે 09:30",
      haldi: "સવારે 11:00 · બપોરનું ભોજન 12:30",
      mameru: "બપોરે 03:00",
      sangeet: "સાંજે 07:30",
      wedding: "",
    },
    venues: {
      tremont: "બી-1302, ટ્રેમોન્ટ, વૈષ્ણોદેવી સર્કલ, અમદાવાદ",
      narayani: "નારાયણી હાઇટ્સ, એરપોર્ટ-ગાંધીનગર રોડ, ભાટ, અમદાવાદ",
    },
